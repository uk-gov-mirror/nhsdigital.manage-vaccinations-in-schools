SELECT
  ...
  pl.school_id                            AS session_location_id,  -- Year group eligibility subquery
  ...
  COALESCE(school.urn, '888888')          AS patient_school_urn,
  COALESCE(school.name, 'Unknown school') AS patient_school_name,
...
-- Where the patient is enrolled this year (links to team via school)
...
JOIN team_locations tl
  ON tl.location_id   = pl.school_id
