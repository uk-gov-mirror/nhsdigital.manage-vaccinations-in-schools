...
describe "Record already vaccinated" do
  scenario "MMRV - given MMR" do
    ...
    then_i_see_a_success_message_for_mmr

    when_i_go_to_a_patient
    and_i_click_on_the_programme
    then_i_see_that_the_status_is_not_yet_vaccinated_for_mmrv
    ...
    when_i_go_to_a_patient
    and_i_click_on_the_programme
    then_i_see_that_the_status_is_vaccinated_for_mmr
  end

  scenario "MMRV - given MMRV" do
    given_i_am_signed_in
    ...
    when_i_confirm_the_details
    then_i_see_a_success_message_for_mmrv
    ...
    when_i_go_to_a_patient
    and_i_click_on_the_programme
    then_i_see_that_the_status_is_vaccinated_for_mmrv
  end
  ...
  def and_i_choose_mmr_was_given
    choose "No, they got the MMR vaccine"
    click_on "Continue"
  end

  def and_i_choose_mmrv_was_given
  ...
  def then_i_see_a_success_message_for_mmr
    expect(page).to have_content("Vaccination outcome recorded for MMR")
  end

  def then_i_see_that_the_status_is_not_yet_vaccinated_for_mmr
    expect(page).to have_content("MMRNeeds consent")
  end

  def then_i_see_that_the_status_is_vaccinated_for_mmr
    expect(page).to have_content("MMRVaccinated")
  end

  def then_i_see_a_success_message_for_mmrv
    expect(page).to have_content("Vaccination outcome recorded for MMRV")
  end

  def then_i_see_that_the_status_is_not_yet_vaccinated_for_mmrv
    expect(page).to have_content("MMRVNeeds consent")
  end

  def then_i_see_that_the_status_is_vaccinated_for_mmrv
    expect(page).to have_content("MMRVVaccinated")
  end
end
